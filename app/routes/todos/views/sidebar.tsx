...
const Sidebar = () => {
    ...
    useEffect(() => {
        ...
        mediaQuery.addEventListener('change', () => {if (!isSidebarOpen) toggleSidebar()})
    }, [activeTodo]);
        ...
        <div className='p-3 md:p-12'>
            ...
            <div className='mb-4'>
                ...
                <textarea
                    ...
                    className='mt-1 block w-full h-80 px-3 py-2 bg-background-600 border border-background-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm'
                />
            </div>
        </div>
    );
